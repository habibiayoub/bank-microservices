...
import com.eazybytes.loans.dto.LoansContactInfosDto;
...
public class LoansController {
    ...
    @Autowired
    private LoansContactInfosDto loansContactInfosDto;
    ...
    public ResponseEntity<LoansContactInfosDto> getContactInfo() {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(loansContactInfosDto);
    }
